...
# ------------------ ASAP7 ----------------------------
export AES_RES=../../results/asap7/jpeg/base_tcp540
export WM_INPUT="${AES_RES}/3_place.odb"
export WM_OUTPUT_ODB="${AES_RES}/3_place_rowparity_wm.odb"
export WM_OUTPUT_DEF="${AES_RES}/3_place_rowparity_wm.def"       # optional
export WM_OUTPUT_CELL_LIST="${AES_RES}/rowparity_wm_cells_embed.csv"           # watermark cell list (embed)
export WM_VERIFY_CELL_LIST="${AES_RES}/rowparity_wm_cells_verify.csv"          # watermark cell list (verify)
export WM_MESSAGE='rowparity-watermark' WM_KEY='This-is-a-secret-key' WM_NUM_CELLS=100
