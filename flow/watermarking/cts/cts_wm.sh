...
Environment (embed):
  ...
  WM_CTS_NUM_PAIRS          number of LCB pairs to watermark (default 32)
  ...
  WM_CTS_SLEW_HEADROOM_FRAC min output slew headroom fraction (default 0.20)
  WM_CTS_SKEW_SLACK_PS      extra worst skew allowed by reassign (default 20)
