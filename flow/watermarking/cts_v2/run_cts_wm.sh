...
export WM_CTS_DELTA_SITES="${WM_CTS_DELTA_SITES:-20}"
export WM_CTS_FANOUT_MARGIN="${WM_CTS_FANOUT_MARGIN:-2}"
export WM_CTS_SLEW_HEADROOM_FRAC="${WM_CTS_SLEW_HEADROOM_FRAC:-0.10}"
...
export WM_CTS_MAX_CAP_FF="${WM_CTS_MAX_CAP_FF:-50}"
export WM_CTS_MAX_ATTEMPTS="${WM_CTS_MAX_ATTEMPTS:-5}"
export WM_CTS_R_MAX="${WM_CTS_R_MAX:-5}"
export WM_CTS_QL_CAP_HEADROOM_FRAC="${WM_CTS_QL_CAP_HEADROOM_FRAC:-0.10}"
export WM_CTS_QL_SETUP_SLACK_PS="${WM_CTS_QL_SETUP_SLACK_PS:-50}"
export WM_CTS_QL_HOLD_SLACK_PS="${WM_CTS_QL_HOLD_SLACK_PS:-30}"
export WM_CTS_AVOID_HOLD_REPAIR="${WM_CTS_AVOID_HOLD_REPAIR:-1}"
export WM_CTS_CHANNEL_BUDGET="${WM_CTS_CHANNEL_BUDGET:-auto}"
