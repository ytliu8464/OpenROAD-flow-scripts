...
export ADDITIONAL_LIBS = $(PLATFORM_DIR)/lib/NLDM/fakeram_256x64.lib

export SDC_FILE               = $(DESIGN_HOME)/$(PLATFORM)/$(DESIGN_NAME)/constraint_evo.sdc

export CORE_UTILIZATION       ?= 45
export CORE_MARGIN            = 2
export MACRO_PLACE_HALO       = 3 3
export CLK_PERIOD             ?= 800
...
export MAX_REPAIR_TIMING_ITER=0
export SKIP_INCREMENTAL_REPAIR=1
export EQUIVALENCE_CHECK=0

export DETAILED_ROUTE_ARGS= -output_guide_coverage /results/$(PLATFORM)/$(DESIGN_NAME)/$(FLOW_VARIANT)/guide_coverage.csv -droute_end_iter $(DETAILED_ROUTE_END_ITERATION)