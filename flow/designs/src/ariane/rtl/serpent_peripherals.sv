...
module serpent_peripherals #(
  ...
  ariane_axi::req_t    br_axi_req;
  ariane_axi::resp_t   br_axi_resp;
  ...
  axi_slave_connect_rev i_bootrom_axi_connect (
    .axi_req_i  ( br_axi_req  ),
    .axi_resp_o ( br_axi_resp ),
    .slave      ( br_master   )
  );
  ...
  noc_axilite_bridge #(
    ...
    //axi lite signals
    //write address channel
    .m_axi_awaddr           ( br_axi_req.aw.addr              ),
    .m_axi_awvalid          ( br_axi_req.aw_valid             ),
    .m_axi_awready          ( br_axi_resp.aw_ready            ),
    //write data channel
    .m_axi_wdata            ( br_axi_req.w.data               ),
    .m_axi_wstrb            ( br_axi_req.w.strb               ),
    .m_axi_wvalid           ( br_axi_req.w_valid              ),
    .m_axi_wready           ( br_axi_resp.w_ready             ),
    //read address channel
    .m_axi_araddr           ( br_axi_req.ar.addr              ),
    .m_axi_arvalid          ( br_axi_req.ar_valid             ),
    .m_axi_arready          ( br_axi_resp.ar_ready            ),
    //read data channel
    .m_axi_rdata            ( br_axi_resp.r.data              ),
    .m_axi_rresp            ( br_axi_resp.r.resp              ),
    .m_axi_rvalid           ( br_axi_resp.r_valid             ),
    .m_axi_rready           ( br_axi_req.r_ready              ),
    //write response channel
    .m_axi_bresp            ( br_axi_resp.b.resp              ),
    .m_axi_bvalid           ( br_axi_resp.b_valid             ),
    .m_axi_bready           ( br_axi_req.b_ready              )
  );

  // tie off signals not used by AXI-lite
  assign br_axi_req.aw.id     = '0;
  assign br_axi_req.aw.len    = '0;
  assign br_axi_req.aw.size   = 2'b11;// 8byte
  assign br_axi_req.aw.burst  = '0;
  assign br_axi_req.aw.lock   = '0;
  assign br_axi_req.aw.cache  = '0;
  assign br_axi_req.aw.prot   = '0;
  assign br_axi_req.aw.qos    = '0;
  assign br_axi_req.aw.region = '0;
  assign br_axi_req.aw.atop   = '0;
  assign br_axi_req.w.last    = 1'b1;
  assign br_axi_req.ar.id     = '0;
  assign br_axi_req.ar.len    = '0;
  assign br_axi_req.ar.size   = 2'b11;// 8byte
  assign br_axi_req.ar.burst  = '0;
  assign br_axi_req.ar.lock   = '0;
  assign br_axi_req.ar.cache  = '0;
  assign br_axi_req.ar.prot   = '0;
  assign br_axi_req.ar.qos    = '0;
  assign br_axi_req.ar.region = '0;
  ...
  ariane_axi::req_t    plic_axi_req;
  ariane_axi::resp_t   plic_axi_resp;
  ...
  noc_axilite_bridge #(
   ...
   .SWAP_ENDIANESS         ( SwapEndianess )
    ...
    //axi lite signals
    //write address channel
    .m_axi_awaddr           ( plic_axi_req.aw.addr         ),
    .m_axi_awvalid          ( plic_axi_req.aw_valid        ),
    .m_axi_awready          ( plic_axi_resp.aw_ready       ),
    //write data channel
    .m_axi_wdata            ( plic_axi_req.w.data          ),
    .m_axi_wstrb            ( plic_axi_req.w.strb          ),
    .m_axi_wvalid           ( plic_axi_req.w_valid         ),
    .m_axi_wready           ( plic_axi_resp.w_ready        ),
    //read address channel
    .m_axi_araddr           ( plic_axi_req.ar.addr         ),
    .m_axi_arvalid          ( plic_axi_req.ar_valid        ),
    .m_axi_arready          ( plic_axi_resp.ar_ready       ),
    //read data channel
    .m_axi_rdata            ( plic_axi_resp.r.data         ),
    .m_axi_rresp            ( plic_axi_resp.r.resp         ),
    .m_axi_rvalid           ( plic_axi_resp.r_valid        ),
    .m_axi_rready           ( plic_axi_req.r_ready         ),
    //write response channel
    .m_axi_bresp            ( plic_axi_resp.b.resp         ),
    .m_axi_bvalid           ( plic_axi_resp.b_valid        ),
    .m_axi_bready           ( plic_axi_req.b_ready         )
  );

  // tie off signals not used by AXI-lite
  assign plic_axi_req.aw.id     = '0;
  assign plic_axi_req.aw.len    = '0;
  assign plic_axi_req.aw.size   = 2'b11;// 8byte
  assign plic_axi_req.aw.burst  = '0;
  assign plic_axi_req.aw.lock   = '0;
  assign plic_axi_req.aw.cache  = '0;
  assign plic_axi_req.aw.prot   = '0;
  assign plic_axi_req.aw.qos    = '0;
  assign plic_axi_req.aw.region = '0;
  assign plic_axi_req.aw.atop   = '0;
  assign plic_axi_req.w.last    = 1'b1;
  assign plic_axi_req.ar.id     = '0;
  assign plic_axi_req.ar.len    = '0;
  assign plic_axi_req.ar.size   = 2'b11;// 8byte
  assign plic_axi_req.ar.burst  = '0;
  assign plic_axi_req.ar.lock   = '0;
  assign plic_axi_req.ar.cache  = '0;
  assign plic_axi_req.ar.prot   = '0;
  assign plic_axi_req.ar.qos    = '0;
  assign plic_axi_req.ar.region = '0;
    ...
    logic [AxiUserWidth-1:0] plic_dummy_user;
    ...
    axi2apb_64_32 #(
        ...
        .AWID_i    ( plic_axi_req.aw.id     ),
        .AWADDR_i  ( plic_axi_req.aw.addr   ),
        .AWLEN_i   ( plic_axi_req.aw.len    ),
        .AWSIZE_i  ( plic_axi_req.aw.size   ),
        .AWBURST_i ( plic_axi_req.aw.burst  ),
        .AWLOCK_i  ( plic_axi_req.aw.lock   ),
        .AWCACHE_i ( plic_axi_req.aw.cache  ),
        .AWPROT_i  ( plic_axi_req.aw.prot   ),
        .AWREGION_i( plic_axi_req.aw.region ),
        .AWUSER_i  ( plic_dummy_user        ),
        .AWQOS_i   ( plic_axi_req.aw.qos    ),
        .AWVALID_i ( plic_axi_req.aw_valid  ),
        .AWREADY_o ( plic_axi_resp.aw_ready ),
        .WDATA_i   ( plic_axi_req.w.data    ),
        .WSTRB_i   ( plic_axi_req.w.strb    ),
        .WLAST_i   ( plic_axi_req.w.last    ),
        .WUSER_i   ( plic_dummy_user        ),
        .WVALID_i  ( plic_axi_req.w_valid   ),
        .WREADY_o  ( plic_axi_resp.w_ready  ),
        .BID_o     ( plic_axi_resp.b.id     ),
        .BRESP_o   ( plic_axi_resp.b.resp   ),
        .BVALID_o  ( plic_axi_resp.b_valid  ),
        .BUSER_o   ( plic_dummy_user        ),
        .BREADY_i  ( plic_axi_req.b_ready   ),
        .ARID_i    ( plic_axi_req.ar.id     ),
        .ARADDR_i  ( plic_axi_req.ar.addr   ),
        .ARLEN_i   ( plic_axi_req.ar.len    ),
        .ARSIZE_i  ( plic_axi_req.ar.size   ),
        .ARBURST_i ( plic_axi_req.ar.burst  ),
        .ARLOCK_i  ( plic_axi_req.ar.lock   ),
        .ARCACHE_i ( plic_axi_req.ar.cache  ),
        .ARPROT_i  ( plic_axi_req.ar.prot   ),
        .ARREGION_i( plic_axi_req.ar.region ),
        .ARUSER_i  ( plic_dummy_user        ),
        .ARQOS_i   ( plic_axi_req.ar.qos    ),
        .ARVALID_i ( plic_axi_req.ar_valid  ),
        .ARREADY_o ( plic_axi_resp.ar_ready ),
        .RID_o     ( plic_axi_resp.r.id     ),
        .RDATA_o   ( plic_axi_resp.r.data   ),
        .RRESP_o   ( plic_axi_resp.r.resp   ),
        .RLAST_o   ( plic_axi_resp.r.last   ),
        .RUSER_o   ( plic_dummy_user        ),
        .RVALID_o  ( plic_axi_resp.r_valid  ),
        .RREADY_i  ( plic_axi_req.r_ready   ),
